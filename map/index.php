                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="nav-item dropdown" id="notlogedin">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="../UserManagement/profile.php"><span class="glyphicon glyphicon-user"></span>&nbsp;View Profile</a></li>
                            <li><a href="../UserManagement/logout.php?logout=true"><span class="glyphicon glyphicon-log-out"></span>&nbsp;Sign Out</a></li>
                        </ul>
                    </li>
                </ul><!--nav-->
            </div><!--navabr-collapse-->
